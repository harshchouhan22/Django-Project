    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctors_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='doctor.doctor')),
            ],
            options={
                'ordering': ['start_time'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.IntegerField(blank=True, default='+91')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Writing_prescription', models.TextField(blank=True, max_length=10000, null=True)),
                ('no', models.CharField(max_length=1000)),
                ('mode', models.CharField(choices=[('In Clinic', 'In Clinic'), ('online(Video Calling)', 'online(Video Calling)')], default='cash on center', max_length=200)),
                ...
                ('timeslots', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.timeslots')),
            ],
        ),
    ]
